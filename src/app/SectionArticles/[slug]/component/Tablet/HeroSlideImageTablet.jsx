    ...
    <ThemeProvider theme={Responsive}>
      ...
      >
          <Box
              ...
              >
            <Box sx={{ ml: {xs:2,sm:3,md:7,lg:5}, cursor: "pointer" }}>
            <svg
              ...
              >
                ...
                <defs>
                 ...
                 <Box sx={{display:"flex",flexDirection:"column",alignItems:"center",width:"1000%",justifyContent:"center"}}>
                    <Box sx={{width:{xs:windowWidth < 400 ? 233 : 266,sm:308},height:{xs:234,sm:271}}}>
                     <Image src={ExImgBlog} style={{width:"100%",height:"100%"}} alt="Picture Article Cover"/>  
                     </Box>
                    <Box sx={{display:"flex",flexDirection:"column",justifyContent:"start",width:"100%",pt:3}}> 
                    <Typography sx={{fontSize: 30, fontWeight: 700, color: "#9747FF"}}>{currentItem && currentItem.label}</Typography>
                    <Typography sx={{fontSize: 18, fontWeight: 400, color: "#667085",mt:2}}>{currentItem && currentItem.content}</Typography>
                    <Box sx={{ display: "flex", justifyContent: "start" ,mt:13}}>
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
...
<Box
            ...
            <Box sx={{ mr: {xs:2,sm:3,md:7,lg:5}, cursor: "pointer" ,}}>
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="36"
                height="36"
