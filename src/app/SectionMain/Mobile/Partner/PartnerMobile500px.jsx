  ...
  return (
    <>
      ...
      <ThemeProvider theme={Responsive}>
        ...
        <Box
          id="Partner-section"
          sx={{ marginTop: "auto", height: "17px", backgroundColor: "#F4FFFA",'@media screen and (min-width: 420px) and (max-width: 500px)': { 
            display: "flex"
          },
          '@media screen and (max-width: 419px), (min-width: 501px)': { 
            display: "none"
          } }}
        ></Box>
        <Box
          ...
          <Grid container spacing={2}>
            <Grid
              ...
              sx={{
                ...
                px:windowWidth < 420 ? 5 : (windowWidth < 450 ? 6 : 10),
