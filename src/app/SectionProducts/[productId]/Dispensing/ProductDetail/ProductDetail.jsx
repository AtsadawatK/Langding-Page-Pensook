     ...
     <ThemeProvider theme={Responsive}>
      <Box
        ...
        '@media screen and (min-width: 820px)': {
          ...
          pt: {md:5,lg:10,xl:15,xxl:10},
          pb: 3,
        }}
      >
        <Typography sx={{ fontSize: {md:30,lg:35,xl:40,xxl:50}, fontWeight: 700, color: "#007DFC" ,textAlign:"center"}}className={noto_Sans_Thai.className}
>
Medical Automation Machine
        </Typography>
       
          <Box sx={{ display: "flex",textAlign:"center",px:15 ,}}>
          <p  style={{color:"#007DFC",fontSize:windowWidth < 1500 ? (windowWidth < 1250 ? "18px" : "30px") : "40px",fontWeight:700}} className={noto_Sans_Thai.className}>Automated Dispensing 
      System Technology <span style={{color:"#5D6471",fontSize:windowWidth < 1500 ? (windowWidth < 1250 ? "18px" : "30px") : "40px",fontWeight:500}}>เป็นตู้จ่ายแบบอัตโมมัติที่จะช่วยลดเวลารอรับยา  ช่วยเพิ่มความ แม่นยำในการจ่ายยา สามารถบันทึกข้อมูลและแสดงรายงานต่าง ๆ เกี่ยวกับการจ่ายยา อาทิเช่น การตรวจสอบ ความถูกต้องของการจ่ายยา ปริมาณยาที่ถูกใช้ไป รวมถึงสามารถ</span> แจ้งเตือนเมื่อยาใกล้หมดไปที่คลังยา</p>
          </Box>
        ...
        >
          ...
          <Box
            sx={{
              ...
              flexDirection: "column",
              alignItems: "center",
              px:{md:0,xl:25/* windowWidth < 1650 ? 20 : 0 */},
              marginBottom: "auto",
            }}
          >
            <Box
            ...
            <Box sx={{ display: "flex", flexDirection: "column", mt: 5 }}>
              <Box sx={{ display: "flex", alignItems: "center" }}>
                ...
                >
                  ...
                  <path fill="url(#pattern1)" d="M11 11H71V71H11z"></path>
                  <defs>
                    <pattern
                      id="pattern1"
                      width="1"
                    ...
                    >
                      <use
                        ...
                        xlinkHref="#image0_2442_22223"
                      ></use>
                    </pattern>
                    <image
                      id="image0_2442_22223"
                      width="128"
                      height="128"
