...
export default function ProductDetail3Mobile() {
     ...
     <ThemeProvider theme={Responsive}>
      ...
      >
        ...
        <Box sx={{ display: "flex",textAlign:"center",px:5 ,}}>
          <p  style={{color:"#007DFC",fontSize:"18px",fontWeight:500}} className={noto_Sans_Thai.className}>PHARMACY VENDING  MACHINE <span style={{color:"#5D6471",fontSize:"18px",fontWeight:500}}>เป็นตู้จ่ายแบบอัตโมมัติที่จะช่วยลดเวลารอรับยา  ช่วยเพิ่มความ แม่นยำในการจ่ายยา สามารถบันทึกข้อมูลและแสดงรายงานต่าง ๆ เกี่ยวกับการจ่ายยา อาทิเช่น การตรวจสอบ ความถูกต้องของการจ่ายยา ปริมาณยาที่ถูกใช้ไป รวมถึงสามารถ</span> แจ้งเตือนเมื่อยาใกล้หมดไปที่คลังยา</p>
          </Box>
