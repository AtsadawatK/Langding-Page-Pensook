...
import PHARMACYMACHINE from  "../../../../../assets/PHARMACYMACHINE SOFTWARE.png"
...
export default function ProductSoftware3Mobile() {
...
const Responsive = createTheme({
  ...
  return (
    ...
    <ThemeProvider theme={Responsive}>
      ...
      >
        <Box sx={{ display: "flex", mt: 8 ,textAlign:"center",flexDirection:"column"}}>
          <Typography sx={{ fontSize: 30, fontWeight: 700, color: "#007DFC" }}className={noto_Sans_Thai.className}>
            PHARMACY VENDING
          </Typography>

          <Typography sx={{ fontSize: 30, fontWeight: 700, color: "#007DFC" ,display: "flex",justifyContent:"center",textAlign:"center",}}className={noto_Sans_Thai.className}>
            MACHINE <Typography
            sx={{ fontSize: 30, fontWeight: 700, color: "#9747FF", ml: 1 }}className={noto_Sans_Thai.className}
          >
            SOFTWARE
          </Typography>
          </Typography>
        ...
        >
          ...
          >
            ...
            >
              <Box sx={{ width: 459, height: 322, position: "relative" }}>
                <Image
                  src={PHARMACYMACHINE}
                  fill={true}
                />
            ...
            >
              ...
              <Box sx={{width:windowWidth < 500 ? "50%" : "70%",display: "flex", justifyContent:"start",flexDirection: "column",}}>
              <Box sx={{ display: "flex", flexDirection: "column" }}>
                <Box sx={{ display: "flex", alignItems: "center" }}>
                  ...
                  >
                    ...
                    <path fill="url(#pattern44)" d="M11 11H49V49H11z"></path>
                    <defs>
                      <pattern
                        id="pattern44"
                        width="1"
              ...
              <Box sx={{ display: "flex", flexDirection: "column", mt: 5 }}>
                <Box sx={{ display: "flex", alignItems: "center" }}>
                  ...
                  >
                    <rect width="60" height="60" fill="#9747FF" rx="30"></rect>
                    <path fill="url(#pattern45)" d="M11 11H49V49H11z"></path>
                    <defs>
                      <pattern
                        id="pattern45"
                        width="1"
              ...
              <Box sx={{ display: "flex", flexDirection: "column",justifycontent:"start", mt: 5 }}>
                <Box sx={{ display: "flex", alignItems: "center" }}>
                  ...
                  >
                    <rect width="60" height="60" fill="#9747FF" rx="30"></rect>
                    <path fill="url(#pattern35)" d="M11 11H49V49H11z"></path>
                    <defs>
                      <pattern
                        id="pattern35"
                        width="1"
