...
export default function ProductGuide1Mobile() {
  ...
  return (
    ...
    <ThemeProvider theme={Responsive}>
      ...
      >
        ...
        <Box sx={{ display: "flex",textAlign:"center",pt:1,zIndex:5,px:5}}>
          <p  style={{color:"#0A5D87",fontSize:"18px",fontWeight:500}} className={noto_Sans_Thai.className}>โลเร็ม อิปซัมเรานำเสนอเทคโนโลยีทางการแพทย์ท<span style={{color:"#007DFC",fontSize:"18px",fontWeight:500}}>ทันสมัยและมีความน่าเชื่อถือ</span> </p>
          </Box>
