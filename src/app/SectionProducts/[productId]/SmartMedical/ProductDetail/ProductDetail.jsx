...
Medical Automation Machine
          ...
          <p  style={{color:"#007DFC",fontSize:windowWidth < 1500 ? (windowWidth < 1250 ? "18px" : "30px") : "40px",fontWeight:700}} className={noto_Sans_Thai.className}>Smart Medical Cabinet <span style={{color:"#5D6471",fontSize:windowWidth < 1500 ? (windowWidth < 1250 ? "18px" : "30px") : "40px",fontWeight:500}}>เป็นตู้จ่ายแบบอัตโมมัติที่จะช่วยลดเวลารอรับยา  ช่วยเพิ่มความ แม่นยำในการจ่ายยา สามารถบันทึกข้อมูลและแสดงรายงานต่าง ๆ เกี่ยวกับการจ่ายยา อาทิเช่น การตรวจสอบ ความถูกต้องของการจ่ายยา ปริมาณยาที่ถูกใช้ไป รวมถึงสามารถ</span> แจ้งเตือนเมื่อยาใกล้หมดไปที่คลังยา</p>
          </Box>
