...
const handleConfirmAll = async () => {
  ...
  <Dialog
    ...
    <Box
        ...
        >
          <Typography
              sx={{ fontSize: {xs:16,xl:24}, fontWeight: 400,  mt:7,}}className={noto_Sans_Thai.className}
            >
          ...
          <Button
            ...
            sx={{
              ...
              mt: 7,
              ml:{md:windowWidth < 870 ? 2 : 3,lg:5},
              "&:hover": {
                bgcolor: "#D5EAFF",
              },
              "&.MuiButton-root": {
...
<Box sx={{display:"flex",justifyContent:"end",width:"80%"}}>
    ...
    <Box sx={{display:{xs:"flex",sm:"none"}, justifyContent:"end", width:"100%" , mr:"48px",alignItems:"center"}}>
...
<Box sx={{display:"flex",justifyContent:"end"}}>
    <Button variant="contained"
          ...
          <Typography
              sx={{ fontSize: {md:16,xl:24}, fontWeight: 400,  mt:7,pr:5,ml:5}}className={noto_Sans_Thai.className}
            >
              บทความทั้งหมด {sortedResult.length} / 9
            </Typography>
    ...
    >
      ...
      <defs>
        ...
        ></image>
                ...
                onClick={() => { window.location.href = `/Admin/EditArticle/${post._id}`; }}
              >
                <Typography
